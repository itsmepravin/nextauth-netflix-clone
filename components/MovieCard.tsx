...
const MovieCard: FC<IMovieCard> = ({ data }) => {
  return (
    <div className="group bg-zinc-900 col-span relative h-[12vw]">
      ...
      />
      <div className="opacity-0 absolute top-0 duration-200 z-10 invisible sm:visible delay-100 w-full scale-0 group-hover:scale-110 group-hover:-translate-y-[6vw] group-hover:opacity-100">
        <img
          src={data.thumbnailUrl}
          alt="Thumbnail"
